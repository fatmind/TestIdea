...
public class PriorityBlockingQueueSet<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
     ...
     *         than 1
     */
    public PriorityBlockingQueueSet(int initialCapacity) {
     ...
     */
    public PriorityBlockingQueueSet(Collection<? extends E> c) {
